...
function init() {
  ...
  style.textContent = [
    ...
    '.vtc-msg-assistant{align-self:flex-start;background:var(--vtc-ink);color:var(--vtc-cream);border-radius:4px 18px 18px 18px}',
    '.vtc-msg-user{align-self:flex-end;background:var(--vtc-teal);color:white;border-radius:18px 4px 18px 18px}',
    '.vtc-msg-assistant strong{color:var(--vtc-gold-light);font-weight:500}',
    '.vtc-typing{align-self:flex-start;padding:12px 16px;background:var(--vtc-ink);border-radius:4px 18px 18px 18px;display:flex;gap:5px;align-items:center}',
